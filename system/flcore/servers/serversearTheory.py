...
class SEARTheory(Server):
    ...
    def robust_aggregate_parameters(self):
        ...
        # Median & Aggregation
        median_vector_model = self.median(matrix_models)
        self.set_params_from_vector(net=self.global_model, vector=median_vector_model)
